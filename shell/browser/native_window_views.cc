...
void NativeWindowViews::SetWindowTransform(
  ...
  switch (transform_type) {
    case blink::mojom::WindowTransformType::kWindowTransformTypeRotate90:
      window_transform = gfx::OVERLAY_TRANSFORM_ROTATE_CLOCKWISE_90;
      break;
    case blink::mojom::WindowTransformType::kWindowTransformTypeRotate180:
      window_transform = gfx::OVERLAY_TRANSFORM_ROTATE_CLOCKWISE_180;
      break;
...
#elif BUILDFLAG(IS_OZONE_WAYLAND) || BUILDFLAG(IS_OZONE_NEXUS)
