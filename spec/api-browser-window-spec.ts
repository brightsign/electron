...
describe('BrowserWindow module', () => {
  ...
  ifdescribe(process.platform === 'linux')('window rotation', () => {
    ...
    const verifyWindowTransform = async (bounds: Electron.Rectangle, transform: WindowTransformTest) => {
      ...
      await setTimeout(500);
      const optionPosition = transform.transformPosition(bounds, SELECT_OPTION_WIDTH_OFFSET, SELECT_OPTION_HEIGHT_OFFSET);
    ...
    describe('SetWindowTransform', () => {
      ...
      windowTransforms.filter(({ name }) => name !== 'none').forEach((transform) => {
